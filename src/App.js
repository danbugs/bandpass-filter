        ...
        <Container>
          ...
          <Row>
            <Col md={6}>
              <Card>
                <CardBody>
                <CardTitle><h2>Bandpass Filter</h2></CardTitle>
            ...
            <Col md={5}>
              <Card>
                ...
                <CardBody>
                  <CardTitle>Phase and frequency of my tuning fork | Frequency Domain</CardTitle>
                  <CardText>We can see that the fundamental frequency of the signal is 493.8Hz, 
                    which is really close to the actual frequency of my tuning fork, 493.9Hz.
